/**
 * @fileoverview Authentication component for user login and signup.
...
/**
 * Represents the authenticated user data returned from the API.
 * @typedef {object} User
...
/**
 * Renders a form that handles both user login and registration.
 * It toggles between the two modes and calls the appropriate API service.
 *
 * @param {object} props - The component's props.
 * @param {(user: User) => void} props.setUser - Callback function to set the authenticated user in the parent component's state.
 * @param {(path: string) => void} props.navigate - Navigation function to redirect the user after successful authentication.
 */
